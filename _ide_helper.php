...
namespace Illuminate\Support\Facades {
     ...
     */        class Request {
         ...
         * 
         *
         * @see \Laravext\LaravextServiceProvider::registerRequestMacro()
         * @static 
         */        public static function laravext()
        {
                        return \Illuminate\Http\Request::laravext();
        }
            }
            /**
     * 
     ...
     */        class Route {
         ...
         * 
         *
         * @see \Laravext\LaravextServiceProvider::registerRouterMacro()
         * @param mixed $uri
         * @param mixed $page
         * @param mixed $root_view
         * @param mixed $parameters
         * @static 
         */        public static function nexus($uri = '{nexusSlug?}', $page = null, $root_view = null, ...$parameters)
        {
                        return \Illuminate\Routing\Router::nexus($uri, $page, $root_view, ...$parameters);
        }
                    /**
         * 
         *
         * @see \Laravext\LaravextServiceProvider::registerRouterMacro()
         * @param mixed $uri
         * @param mixed $route_group_attributes
         * @param mixed $root_view
         * @static 
         */        public static function laravext($uri = null, $route_group_attributes = [], $root_view = null)
        {
                        return \Illuminate\Routing\Router::laravext($uri, $route_group_attributes, $root_view);
        }
            }
            /**
     * 
